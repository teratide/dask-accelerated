...
if __name__ == '__main__':
    ...
    if args.vanilla:
        helpers.run_vanilla(in_size, batch_size, batch_aggregate)

    if args.re2:
        helpers.run_re2(in_size, batch_size, batch_aggregate)

    if args.tidre:
        helpers.run_tidre(in_size, batch_size, batch_aggregate)
